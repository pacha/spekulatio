...
* `_action.title`: (String) Top level title of the document. Empty string if not present.
* `_action.toc`: (Nested list of strings) Table of contents of the document.
* `_action.src`: (String) Original Markdown content.
